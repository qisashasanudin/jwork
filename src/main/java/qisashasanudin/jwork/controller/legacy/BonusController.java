...
// public Bonus addBonus(@RequestParam(value = "referralCode") String
// referralCode,
// @RequestParam(value = "extraFee") int extraFee, @RequestParam(value =
// "minTotalFee") int minTotalFee,
// @RequestParam(value = "active") boolean active) {
// Bonus bonus = new Bonus(DatabaseBonus.getLastId() + 1, referralCode,
// extraFee, minTotalFee, active);
// try {
